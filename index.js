...
function runSecuredCode() {
    ...
    document.title = "Numere Periodice - D3sTeptu";

    const link = document.createElement("link");
        link.rel = "icon";
        link.href = "https://cdn.discordapp.com/attachments/880374659953090581/1070087019289661500/wen-icon.png";
        link.type = "image/x-icon";
    document.head.appendChild(link);

    const image = document.createElement("img");
        image.setAttribute("src", "https://cdn.discordapp.com/attachments/1041401860130607166/1070072204546543636/rich.jpg");
    containerDiv.appendChild(image);

    const h1 = document.createElement("h1");
        h1.textContent = "Numere Periodice - D3sTeptu";
    containerDiv.appendChild(h1);

    const textarea = document.createElement("textarea");
        textarea.setAttribute("id", "pageCode");
        textarea.setAttribute("placeholder", "Adauga aici codul copiat");
